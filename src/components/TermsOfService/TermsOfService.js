  ...
  return (
    <div className={classes}>
      ...
      <p>
        ...
        provided by Marco Nicotra. ("Boxitonline," "we," or "us"). This Terms of Service Agreement ("Agreement") 
        describes the terms and conditions that govern your use of and participation in Boxitonline services. 
      ...
      <p>
        ...
        You understand and agree that Boxitonline is not a party to any agreements entered 
      ...
      <h2>2) End User License</h2>
      <p>
        Subject to the terms and conditions of this Agreement, you are hereby granted a non-exclusive, 
        limited, non-transferable, freely revocable, license to use the Service for your personal, 
        noncommercial use only. Boxitonline may terminate this license at any time for any reason or no reason.
      </p>

      <h2>3) Indemnity</h2>
      <p>
        You agree to defend, indemnify and hold harmless Boxitonline and its subsidiaries, agents, 
        ...
        (i) your use of and access to the Service or Products; 
        (ii) your violation of any term of this Agreement, including without limitation 
      ...
      <h2>4) No Warranty</h2>
      <p>
        If you choose to use the service and/or participate in a rental, you do so at your own risk.  
        The service and any products are provided on an “as is” and “as available” basis.  
        To the maximum extent permitted by applicable law, the service is provided without warranties of any kind, 
        whether express or implied, including, but not limited to implied warranties of merchantability, 
        fitness for a particular purpose, or non-infringement.  
        No advice or information, whether oral or written, obtained by you from Boxitonline or 
        through the service will create any warranty not expressly stated herein.  
        Without limiting the foregoing, Boxitonline, its subsidiaries, and its licensors do not warrant 
        that the content is accurate, reliable or correct; that the service or any rental will meet your requirements; 
        ...
        You will be solely responsible for any damage or loss that results from your use of the service or products.
      </p>
      ...
      <p>
        To the maximum extent permitted by applicable law, Boxitonline assumes no liability or responsibility for any 
        (I) Errors, mistakes, or inaccuracies of content; 
        (II) Personal injury or property damage of any nature whatsoever, resulting from your access to or 
        use of our service or products; 
        ...
        (V) Any bugs, viruses, or the like that may be transmitted to or through our service by any third party; 
        (VI) Any errors or omissions in any content or for any loss or damage incurred as a result of the us of any content posted, 
      ...
      <p>
        ...
        but may be assigned by Boxitonline without restriction.  Any attempted transfer or assignment in violation hereof 
        shall be null and void.
      </p>

      <h2>7) Termination</h2>
      <p>
        We may terminate your participation in the Service at any time, for any reason or no reason, without explanation. 
        We maintain sole discretion to bar your use of the Service in the future, for any reason that we determine or for no reason. 
      ...
      <p>
        ...
        injunctive or other equitable relief from the courts as necessary to protect any of Boxitonline’s proprietary interests. 
        All claims must be brought in the party’s individual capacity, and not as a class member in any purported class or 
        representative proceeding.  You agree that, by entering into this agreement, you and Boxitonline are each waiving the right 
        to a trial by jury or to participate in a class action.
      </p>

      <h2>10) Entire Agreement/Severability</h2>
      <p>
        This Agreement, together with all amendments, all documents referenced in this Agreement, and any other legal notices 
        and agreements published by Boxitonline via the Service, shall constitute the entire agreement between you and Boxitonline 
        concerning the Service. If a court of competent jurisdiction deems any provision of this Agreement invalid, the invalidity 
        of such provision shall not affect the validity of the remaining provisions of this Agreement, which shall remain in full 
        force and effect.
      </p>
      ...
      <p>
        ...
        and Quiver’s failure to assert any right or provision under this Agreement shall not constitute a waiver of such right or 
        provision.
      </p>
    </div>
  );
