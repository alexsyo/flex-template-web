...
export const HostLandingPageComponent = props => {
  ...
  const schemaTitle = intl.formatMessage({ id: 'HostLandingPage.schemaTitle' }, { siteTitle });
  const schemaDescription = intl.formatMessage({ id: 'HostLandingPage.schemaDescription' });
